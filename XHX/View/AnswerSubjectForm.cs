...
namespace XHX.View
{
    public partial class AnswerSubjectForm : Form
    {
        ...
        public AnswerSubjectForm(string projectCode, string subjectCode, string shopCode, string shopName, int order, char checkType, UserInfoDto userinfodto,string examType)
        {
            InitializeComponent();
        ...
        private void btnUploadDataToServer_Click(object sender, EventArgs e)
        {
            ...
            foreach (string name in AllFilesList)
            {
                ...
                Upload(name, ("ftp://106.120.243.177//" + url).Replace("\\", "//"), "dsat", "dsat2011");
            }
        }
