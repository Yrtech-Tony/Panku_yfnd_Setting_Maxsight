...
namespace XHX.View
{
    ...
    public partial class AnswerRecheckLastDtl : BaseForm
    {
        ...
        public AnswerRecheckLastDtl(string projectCode, string subjectCode, string shopCode, int order, char checkType, string examType)
        {
            InitializeComponent();
