...
namespace XHX.ViewLocalService
{
    public partial class SpecialCasePop : Form
    {
            ...
            : this()
        {
           ...
           //GetSubject(webService.SearchAnswer(CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text, txtSubjectCode.Text));
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string RegType = "10";
            //保存特殊案例信息
            DataSet ds = webService.InsertSpecialCase(SpecialCaseCode, CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text, txtSubjectCode.Text, txtTitle.Text, txtApplyDesc.Text, txtTreatmentAdvice.Text, RegType, _userinfo.UserID, txtFilePath.Text, chkNeedVICoConfirmChk.Checked, txtVICoAdvice.Text);
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //保存特殊案例信息
            DataSet ds = webService.InsertSpecialCase(SpecialCaseCode, CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text, txtSubjectCode.Text, txtTitle.Text, txtApplyDesc.Text, txtTreatmentAdvice.Text, RegType, _userinfo.UserID, txtFilePath.Text, chkNeedVICoConfirmChk.Checked, txtVICoAdvice.Text);
            //webService.UpDateAnswer(CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text, txtSubjectCode.Text,
            //    chkNewScore.Checked ? "9999.00" : txtNewScore.Text);
            CommonHandler.ShowMessage(MessageType.Information, "保存成功!");
            this.SearchSpecialCase(SpecialCaseCode);
        }
        //点击查看图片时的操作
        ...
        //public bool GetSubject(DataSet ds)
        //{
        ...
        //        {
        //            chkOldScore.Checked = true;
        //            chkNewScore.Checked = true;
        //            txtOldScore.Text = string.Empty;
        //            txtNewScore.Text = string.Empty; ;
        //        }
        //        else
        //        {
        //            txtOldScore.Text = subjectDto.Score.ToString();
        //            txtNewScore.Text = subjectDto.Score.ToString();
        //        }
        ...
        private void btnCheckAnswer_Click(object sender, EventArgs e)
        {
            ...
            AnswerSubjectForm a = new AnswerSubjectForm(projectCode,
                subjectCode,
                shopCode, txtShopName.Text, order, checkType, _userinfo, examType);
            a.ShowDialog();
        }
